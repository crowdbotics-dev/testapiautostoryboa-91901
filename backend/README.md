...
## Project Structure
    ...
    ├── testapiautostoryboa_91901  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_91901`
...
2. Clone this repo and `cd testapiautostoryboa_91901`
